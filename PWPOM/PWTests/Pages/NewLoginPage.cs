...
namespace PWPOM.PWTests.Pages
{
    ...
    {
        private IPage _page;
        private ILocator LoginLnk => _page.Locator(selector: "text=Login");
        private ILocator InpPassword => _page.Locator(selector: "#UserName");
        private ILocator InpUserName => _page.Locator(selector: "#Password");
        ...
        public async Task ClickLogInLink() => await LoginLnk.ClickAsync();
        ...
        public async Task<bool> CheckWelcomeMssg() => await LnkWelMess.IsVisibleAsync();
